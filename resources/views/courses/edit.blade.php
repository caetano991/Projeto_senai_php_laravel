    ...
    <div class="card mb-4">
        <div class="card-header hstack gap-2">
            ...
            <span class="ms-auto d-sm-flex flex-row">
                ...
                <a href="{{ route('courses.show', ['course' => $course->id]) }}" class="btn btn-primary btn-sm me-1 mb-1 mb-sm-0">Visualizar</a>
        ...
        <div class="card-body">
            ...
            <form class="row g-3" action="{{ route('courses.update', ['course' => $course->id]) }}" method="POST">
                ...
                <div class="col-12">
                    ...
                    <input type="number" step="0.01" class="form-control" id="price" name="price" placeholder="Preço do curso 2.47 Usar '.'separar real do centavo" value="{{ old('price', $course->price) }}" required>
                </div>
                <div class="col-12">
